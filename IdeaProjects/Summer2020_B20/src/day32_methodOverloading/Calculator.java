...
// write a return method that accepts two nums and an operator, then returns calculation
//result. if the operator is invalid, return zero;
// otherwise rethen the result
